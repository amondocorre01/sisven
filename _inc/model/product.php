	...
	public function addProduct($data) 
	{
    	...
    	if (isset($data['product_store']) && $product_id) {
			...
			//--- product to store ---//
				...
				$statement->execute(array($product_id, $store_id, 66, $data['sell_price'], $data['sup_id'], $data['brand_id'], $data['box_id'], $data['taxrate_id'], $data['tax_method'], $preference, $data['e_date'], $data['alert_quantity'], date('Y-m-d')));
