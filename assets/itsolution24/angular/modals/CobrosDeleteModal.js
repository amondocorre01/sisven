window.angularApp.factory("CobrosDeleteModal", ["API_URL", "window", "jQuery", "$http", "$uibModal", "$sce", "$rootScope", function (API_URL, window, $, $http, $uibModal, $sce, $scope) {
    return function(product) {
        ...
        var uibModalInstance = $uibModal.open({
            ...
            template: "<div class=\"modal-header\">" +
                            "<button ng-click=\"closeCobrosDeleteModal();\" type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button>" +
            ...
            controller: function ($scope, $uibModalInstance) {
                $http({
                  url: window.baseUrl + "/_inc/cobros.php?p_id=" + product.id_cobro + "&action_type=DELETE",
                  method: "GET"
                })
                ...
                $scope.closeCobrosDeleteModal = function () {
